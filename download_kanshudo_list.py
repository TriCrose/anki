...
def get_listing_urls() -> List[Tuple[str, int]]:
...
if __name__ == "__main__":
    urls_with_counts = get_listing_urls()
    download_all_kanji(urls_with_counts, sys.argv[1] if len(sys.argv) > 1 else "word_list.csv")
